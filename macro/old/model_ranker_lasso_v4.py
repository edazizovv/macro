...
reported_mean = reported_mean.sort_values(by='enter_step')
gx = numpy.where(reported_mean['sd_improvement'].values <= 0)[0][0]
x_base = reported_mean.iloc[:gx, :]['enter_step'].dropna().index.values.tolist()
